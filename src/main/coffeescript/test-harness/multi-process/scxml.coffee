...
define ["scxml/SCXML","test-harness/multi-process-browser/initialize-json-test-descriptor","scxml/event","util/utils","util/readline","lib/json2"],(scxml,initializeJsonTest,Event,utils,readline) ->
