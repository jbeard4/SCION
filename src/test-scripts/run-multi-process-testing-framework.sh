...
$basedir/src/test-scripts/run-module.sh test-harness/multi-process/server node -stopOnFail -performanceTestMode -projectDir $basedir -local -numLocalProcesses 1 -interpreters $interpreters -verbose -logFile out.txt
