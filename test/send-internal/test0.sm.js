//Generated on Tuesday, February 19, 2013 20:38:24 by the SCION SCXML compiler
...
function $send_line_29_column_74(_event, In, _sessionId, _name, _ioprocessors, _x){
    ...
    if(_scionTargetRef === '#_internal'){
         this.raise(
         {
            ...
            name: $eventexpr_line_29_column_34.apply(this, arguments),
            type: "send",
            data: 
                {
                    "foo":foo,
...
function $eventexpr_line_29_column_34(_event, In, _sessionId, _name, _ioprocessors, _x){
    return 's1';
}
...
function $send_line_43_column_55(_event, In, _sessionId, _name, _ioprocessors, _x){
    ...
    if(_scionTargetRef === '#_internal'){
         ...
         {
            target: _scionTargetRef,
            name: $eventexpr_line_43_column_34.apply(this, arguments),
            type: "send",
            data: 
                "More content.",
            origin: _sessionId
...
function $eventexpr_line_43_column_34(_event, In, _sessionId, _name, _ioprocessors, _x){
    return 's2';
}
