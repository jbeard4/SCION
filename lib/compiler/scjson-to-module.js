...
var resolveUri = require('../runtime/url-resolver');
...
const invokeTypes = {
  "http://www.w3.org/TR/scxml/" : function(invoke, builder){
    ...
    if(invoke.content){
      ...
      method = 'invoke';
      arg = resolveUri(builder.docUrl, invoke.src);
    } else{
    ...
    return `
      scxml.${method}(
        ...
        {
          params : ${actionWithNamelistAndParamsToProps(invoke, builder)},
          parentSession : this,
          docUrl : ${invoke.content && JSON.stringify(builder.docUrl)},
          docOffsetLine : ${invoke.content && invoke.$line},
          docOffsetColumn : ${invoke.content && invoke.$column}
...
invokeTypes['scxml'] = invokeTypes[DEFAULT_INVOKE_TYPE];
