...
function generateFnDeclaration(fnName,fnBody,action,docUrl,isExpression){
...
ModuleBuilder.prototype.generateActionFunction = function(action) {
    ...
    var fnDec = generateFnDeclaration(fnName,fnBody,action,this.docUrl,false);
...
ModuleBuilder.prototype.generateExpressionFunction = function(expressionType,exprObj){
    ...
    var fnDec = generateFnDeclaration(fnName,exprObj.expr,exprObj,this.docUrl,true);
