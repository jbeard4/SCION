        ...
        var action = merge(
                    {
                        ...
                        //Replacing everything except letters and numbers to '_'.
                        //This prevents illegal syntax functions like "function http.request() {}"
                        $type: node.local.replace(/[^0-9a-zA-Z-]/g, '_')
                    },
