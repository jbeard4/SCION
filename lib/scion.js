...
(function (root, factory) {
    ...
    BaseInterpreter.prototype = {
        ...
        _performBigStep : function(e) {
            console.log('_performBigStep',e);
            if (e) this._internalEventQueue.push(e);
            console.log('this._internalEventQueue',this._internalEventQueue);
            var keepGoing = true;
            while (keepGoing) {
                var currentEvent = this._internalEventQueue.shift();
    ...
    Statechart.prototype.gen = function(evtObjOrName,optionalData) {
        ...
        console.log('gen',evtObjOrName,this._internalEventQueue);
    ...
    InterpreterScriptingContext.prototype = {
        ...
        send : function(event, options){
            ...
            //console.log('eventProcessorTypes',eventProcessorTypes,' event.type', event.type);
