...
function BaseInterpreter(modelOrFnGenerator, opts){
    ...
    this._scriptingContext.log = this._scriptingContext.log || (function log(){ this.opts.console.log.apply(this.opts.console, arguments); }.bind(this));   //set up default scripting context log function
