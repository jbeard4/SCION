...
(function (root, factory) {
    ...
    function initializeModel(rootState){
        ...
        function connectTransitionGraph(){
            ...
            transitions.forEach(function(t){
                ...
                //console.log('lcca',t.source.id,t.lcca.id);
                t.scope = getScope(t);
            });
        }
        ...
        function getLCCA(s1, s2) {
            //TODO: make sure he is a COMPOSITE type, not PARALLEL!
            var commonAncestors = [];
    ...
    BaseInterpreter.prototype = {
        ...
        _performBigStep : function(e) {
            if (e) this._internalEventQueue.push(new this.opts.Set([e]));
            var keepGoing = true;
            while (keepGoing) {
                var eventSet = this._internalEventQueue.length ? this._internalEventQueue.shift() : new this.opts.Set();
        ...
        _performSmallStep : function(eventSet) {
            ...
            if (!selectedTransitions.isEmpty()) {
                ...
                var evaluateAction = this._evaluateAction.bind(this, eventSet, eventsToAddToInnerQueue);        //create helper fn that actions can call later on
        ...
        /** @private */
        _evaluateAction : function(eventSet, eventsToAddToInnerQueue, actionRef) {
        ...
        _selectTransitions : function(eventSet) {
            ...
            var e = function(t) { return t.cond(); };
