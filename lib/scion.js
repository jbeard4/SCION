...
(function (root, factory) {
    ...
    function InterpreterScriptingContext(interpreter, customSend) {
    ...
    InterpreterScriptingContext.prototype = {
        ...
        send : function(event, options){
            var eventAction = this.customSend || this._interpreter.gen;
            ...
            if(options.delay === undefined){
                setTimeout(eventAction.bind(this._interpreter,event),0);
            }else{
                ...
                var timeoutId = setTimeout(eventAction.bind(this._interpreter,event), options.delay || 0);
