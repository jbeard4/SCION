...
BaseInterpreter.prototype = extend(beget(EventEmitter.prototype),{
    ...
    _handleError : function(e, actionRef){
      let event = 
        e instanceof Error || e.__proto__.name.match(/^.*Error$/) ?  //we can't just do 'e instanceof Error', because the Error object in the sandbox is from a different context, and instanceof will return false
          {
