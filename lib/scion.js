...
(function (root, factory) {
    ...
    InterpreterScriptingContext.prototype = {
        ...
        send : function(event, options){
            function eventAction (event, options) {
            ...
            eventAction = this._interpreter.opts.customSend || eventAction;
            ...
            eventAction.apply(this, [event, options]);
        },
        cancel : function(sendid){
            if(this._interpreter.opts.customSend) {
                return this._interpreter.opts.customSend.apply(this, [sendid]);
            }
