...
module.exports = {
  ...
  IS_INSPECTING : (process.execArgv && process.execArgv.indexOf('--inspect') > -1) 
};
...
function initContexts(executionContext, hostContext){
    ...
    executionContext['scxml'] = require('..');    //add scxml module to the runtime in order to support <invoke>
