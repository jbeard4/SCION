  ...
  "http://www.w3.org/TR/scxml/" : function(invokingSession, invokeObj, cb){
    ...
    if(invokeObj.content){
      ...
      arg = typeof invokeObj.content === 'string' ? 
              invokeObj.content : 
              xmlserializer.serializeToString(invokeObj.content);      //FIXME: this serializer is only likely to work with jsdom. we should use a more portable method to serialize DOM document
