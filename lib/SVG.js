...
SVGRenderer.prototype = {
  ...
  _exitKGraphObject : function(kgraphNode, property, recursiveDelete){
    ...
    if(kgraphNode.id === 'root' && property === 'edges') console.log('cachedNodes', JSON.stringify(cachedNodes,4,4));
    ...
    if(kgraphNode.id === 'root' && property === 'edges') console.log('nodesToCache', JSON.stringify(nodesToCache,4,4)); 
