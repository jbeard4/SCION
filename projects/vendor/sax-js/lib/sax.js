;(function (sax) { // wrapper for non-node envs
  ...
  function emitEntity (parser, s) {
    emit(parser, 'onentity', s)
    return s
  }
  ...
  function parseEntity (parser) {
    ...
    if (parser.ENTITIES[entityLC]) {
      return emitEntity(parser, parser.ENTITIES[entityLC])
    }
    entity = entityLC
    if (entity.charAt(0) === '#') {
    ...
    if (numStr.toLowerCase() !== entity) {
      ...
      return emitEntity(parser, '&' + parser.entity + ';')
    }

    return emitEntity(parser, String.fromCodePoint(num))
  }
      ...
      switch (parser.state) {
        ...
        case S.ATTRIB_VALUE_ENTITY_U:
          ...
          if (c === ';') {
            ...
            if (!parser.entity.length) {
              emit(parser, 'onentitystart')
            }
            parser.entity += c
          } else {
