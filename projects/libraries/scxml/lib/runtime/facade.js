...
core.InterpreterScriptingContext.invokers = invokers.invokeTypes;    //set up default invokers
core.InterpreterScriptingContext.xmlParser = {
...
module.exports = {
    ...
    get scion(){
      console.warn('scxml.scion property is now deprecated. Use property scxml.core instead (or scion.core in the browser)');
      return core;
    },
    core,
    util : util,
