...
import toggleScxml from './toggle.scxml'

export { toggleScxml }

export default class XStateToggleExample extends React.Component {
  constructor(props) {
    super(props)
    this.state = { log: [] }
  }
  ...
  componentDidMount() {
    scxml.documentStringToModel(null, toggleScxml, (err, model) => {
      if (err) throw err
    ...
    return (
      <div className="row" style={{ minHeight: '500px' }}>
        <div className="col-md-8" style={{ marginBottom: '1rem' }}>
          <div style={{ height: '500px', width: '100%', position: 'relative', border: '1px solid #eee' }}>
            <SCHVIZ
              scxmlDocumentString={toggleScxml}
